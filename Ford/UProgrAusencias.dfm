object FrmProgrAusencias: TFrmProgrAusencias
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Programar Aus'#234'ncias'
  ClientHeight = 462
  ClientWidth = 591
  Color = clBtnFace
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Alignment = taCenter
          Title.Caption = 'Data Aus'#234'ncia'
          Title.Font.Charset = DEFAULT_CHARSET
          Title.Font.Color = clWindowText
          Title.Font.Height = -13
          Title.Font.Name = 'Tahoma'
  ...
  object QRMotorista: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select nome, turno from cadmotorista')
    Left = 376
    Top = 352
