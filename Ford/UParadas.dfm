object FrmParadas: TFrmParadas
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'C'#243'digos de Paradas'
  ClientHeight = 383
  ClientWidth = 708
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from cadparadas order by codparada')
    Left = 192
    Top = 224
  end
