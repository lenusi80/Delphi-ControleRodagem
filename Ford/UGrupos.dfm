object FrmCadGrupos: TFrmCadGrupos
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DateTimePicker1: TDateTimePicker
        ...
        Date = 39053.383523761570000000
        Time = 39053.383523761570000000
        TabOrder = 4
        TabStop = False
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM CADGRUPOS order by grupo')
    Left = 280
    Top = 348
    object ADOQuery1Grupo: TIntegerField
      FieldName = 'Grupo'
    end
    object ADOQuery1DataInicio: TDateTimeField
      FieldName = 'DataInicio'
    end
    object ADOQuery1DataVolta: TDateTimeField
      FieldName = 'DataVolta'
    end
    object ADOQuery1TipoEscala: TWideStringField
      FieldName = 'TipoEscala'
      Size = 3
    end
